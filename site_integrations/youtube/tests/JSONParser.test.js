...
describe('YouTubeJSONParser', () => {
  ...
  it('should reject autogenerated subtites', done => {
    const captionFile = fs.readFileSync(path.resolve(__dirname, './assets/autogenerated-subtitles.txt'));
    YouTubeJSONParser(captionFile)
      .then(captions => {
      ...
      .catch(err => {
        // expect(err).to.equal('Autogenerated captions not supported.');
